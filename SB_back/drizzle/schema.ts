...
export const profiles = mysqlTable("profiles", {
  ...
  importantInStudy: json("importantInStudy").$type<string[]>(),
  importantTraits: json("importantTraits").$type<string[]>(),
  partnerLearningStyle: json("partnerLearningStyle").$type<string[]>(),
