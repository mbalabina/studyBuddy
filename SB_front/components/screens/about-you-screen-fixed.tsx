    ...
    <div className="flex flex-col min-h-dvh px-6 animate-fade-in">
      ...
      {step === "about-step3" && (
        <div className="flex-1 flex flex-col animate-slide-in-right">
          ...
          <div className="space-y-5">
            {/* Messenger selection - FIXED with VK support */}
            <div>
  ...
  return (
    <div className="flex flex-col min-h-dvh items-center justify-center px-6">
      ...
      <p className="text-sm text-gray-500 text-center mb-8">
        Теперь давай заполним анкету о твоих предпочтениях
      </p>
      <button onClick={() => setScreen("survey1")} className="btn-green !w-auto px-8">
        Дальше
      </button>
    </div>
  )
    ...
    <div className="flex flex-col min-h-dvh px-6 animate-fade-in">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="space-y-5">
          <input
            type="text"
            placeholder="Название цели (например, IELTS)"
            value={goalName}
          ...
          <textarea
            ...
            className="w-full py-3 border-b border-gray-200 focus:border-black outline-none transition-colors text-base resize-none"
            rows={3}
          />
        </div>
...
function Congrats2Screen() {
  ...
  return (
    <div className="flex flex-col min-h-dvh items-center justify-center px-6">
      ...
      <p className="text-sm text-gray-500 text-center mb-8">
        Теперь ты можешь начать искать бадди
      </p>
